...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            ...
            [
                'staff_code'    => '246135',
                'name'          => 'Nguyễn Văn AM 1',
                'email'         => 'nguyenvanam1@gmail.com',
                'password'      => Hash::make('123456'),
                'avatar'        => 'hik.jpg',
                'enabled'       => 1,
            ...
            [
                'staff_code'    => '123234',
                'name'          => 'Nguyễn Văn AM 2',
                'email'         => 'nguyenvanam2@gmail.com',
                'password'      => Hash::make('123456'),
                'avatar'        => 'hik.jpg',
                'enabled'       => 1,
            ...
            [
                'staff_code'    => '123234',
                'name'          => 'Nguyễn Văn PM 1',
                'email'         => 'nguyenvanpm1@gmail.com',
                'password'      => Hash::make('123456'),
                'avatar'        => 'hik.jpg',
                'enabled'       => 1,
            ...
            [
                'staff_code'    => '123234',
                'name'          => 'Nguyễn Văn PM 2',
                'email'         => 'nguyenvanpm2@gmail.com',
                'password'      => Hash::make('123456'),
                'avatar'        => 'hik.jpg',
                'enabled'       => 1,
            ...
            [
                'staff_code'    => '123234',
                'name'          => 'Nguyễn Văn Member 1',
                'email'         => 'nguyenvanmember1@gmail.com',
                'password'      => Hash::make('123456'),
                'avatar'        => 'hik.jpg',
                'enabled'       => 1,
            ...
            [
                'staff_code'    => '234689',
                'name'          => 'Nguyễn Văn Member 2',
                'email'         => 'nguyenvanmember2@gmail.com',
                'password'      => Hash::make('123456'),
                'avatar'        => 'hik.jpg',
                'enabled'       => 1,
                'description'   => 'Đây là user 9',
            ],
        ]);
